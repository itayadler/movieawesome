...
DONE! Ruby script that creates CSV files for the Movie/Person nodes and their relationships.
DONE! A UI for offering movie recommendations based on a Movie using EmberJS.
